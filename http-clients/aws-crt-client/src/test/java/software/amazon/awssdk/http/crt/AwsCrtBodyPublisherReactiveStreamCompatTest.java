...
public class AwsCrtBodyPublisherReactiveStreamCompatTest extends PublisherVerification<ByteBuffer> {
    private static final Logger log = Logger.loggerFor(AwsCrtBodyPublisherReactiveStreamCompatTest.class);

    public AwsCrtBodyPublisherReactiveStreamCompatTest() {
