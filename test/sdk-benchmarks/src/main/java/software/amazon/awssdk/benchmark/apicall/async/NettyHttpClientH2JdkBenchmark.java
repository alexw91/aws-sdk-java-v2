...
public class NettyHttpClientH2JdkBenchmark {
    ...
    public static void main(String... args) throws Exception {
        NettyHttpClientH2JdkBenchmark benchmark = new NettyHttpClientH2JdkBenchmark();
        benchmark.mockServer = new MockHttp2Server(HTTP_PORT_NUMBER, HTTPS_PORT_NUMBER, true);
