...
public class NettyHttpClientJdkSslBenchmark {
...
//            .include(NettyHttpClientSslBenchmark.class.getSimpleName() + ".concurrentApiCall")
//            .include(NettyHttpClientBenchmark.class.getSimpleName() + ".concurrentApiCall")
...
//    }
        ...
        public static void main(String... args) throws Exception {
            NettyHttpClientJdkSslBenchmark benchmark = new NettyHttpClientJdkSslBenchmark();
            benchmark.mockServer = new MockServer(HTTP_PORT_NUMBER, HTTPS_PORT_NUMBER);
